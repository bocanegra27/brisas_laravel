...
// MÓDULO: PEDIDOS
    Route::controller(PedidoController::class)->prefix('pedidos')->group(function () {
        ...
        // Acciones sobre pedidos (CRUD básico)
        ...
        Route::post('/{id}/estado-historial', 'actualizarEstadoConHistorial'); // Soporte para imágenes
        Route::get('/{id}/historial', 'obtenerHistorial')->name('admin.pedidos.historial');
        
        // MÓDULO: Diseño 3D y Archivos (Tu especialidad)
        ...
        // NUEVA FUNCIONALIDAD: Fase Final de Joyería
