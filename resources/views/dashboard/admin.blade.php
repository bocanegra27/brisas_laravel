...
<main class="container mt-4 pb-5">
    ...
    {{-- Gestión General - AHORA ARRIBA --}}
    <h2 class="section-header animate-in animate-delay-1">Gestión General</h2>
    ...
    {{-- Estado de la Producción - AHORA DEBAJO --}}
    <h2 class="section-header animate-in animate-delay-2">Estado de la Producción</h2>
