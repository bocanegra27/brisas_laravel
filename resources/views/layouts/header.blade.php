    ...
    <div class="header-minimal__container">
        ...
        <nav class="header-minimal__nav" id="headerNav">
            ...
            @elseif($isDesigner)
                ...
                {{-- 🔥 CORRECCIÓN APLICADA: Usar route() con el nombre correcto --}}
                <a href="{{ route('designer.pedidos.index') }}" 
            ...
            @elseif($isUser)
                ...
                {{-- CORRECCIÓN MANTENIDA: Ruta correcta usando route helper --}}
            ...
            @else
                ...
                <div class="header-minimal__user-dropdown" id="userDropdown">
                    ...
                    <div class="header-minimal__dropdown-menu">
                        ...
                        @if($isUser)
                            {{-- Usuario: Mis Pedidos --}}
                            {{-- CORRECCIÓN MANTENIDA: Ruta correcta en el dropdown --}}
...
{{-- ===== JAVASCRIPT PARA INTERACTIVIDAD (Mantenido) ===== --}}
@push('scripts')
<script>
