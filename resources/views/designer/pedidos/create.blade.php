            ...
            <div class="card border-0 shadow-sm animate-in">
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('designer.pedidos.index') }}" class="btn btn-sm btn-outline-secondary">
                            <i class="bi bi-x-lg"></i> Cancelar
                        </a>
                    </div>
                </div>
                <div class="card-body p-4">
                    {{-- RUTA AJUSTADA: De admin.pedidos.store a designer.pedidos.store --}}
                    <form action="{{ route('designer.pedidos.store') }}" method="POST">
                        @csrf
                        
                        {{-- Selección de Tipo de Cliente (Sin cambios) --}}
                        <div class="mb-4">
                        ...
                        {{-- Campos Dinámicos (Sin cambios en el HTML, solo la data de Laravel) --}}
                        <div id="campoRegistrado" class="mb-4">
                            ...
                            <select name="usuIdCliente" class="form-select" id="selectUsuario">
                                ...
                                @foreach($usuarios as $user)
                                    {{-- El filtro de rol sigue siendo válido --}}
                        ...
                        {{-- Detalles del Pedido (Sin cambios) --}}
                        <div class="mb-4">
